...
const config = {
  title: "W3C Validator",
  tagline: "CLI for W3C Markup Validation Service",
  favicon: "img/w3c.ico",
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/jokay03J-V2/w3c-validator/tree/docs",
        },
        blog: {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © 2023-${new Date().getFullYear()} w3c-validator, Inc. Built with Docusaurus.`,
      },
      prism: {
